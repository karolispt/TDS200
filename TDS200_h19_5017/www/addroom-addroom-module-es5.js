...
var AddroomPage = /** @class */ (function () {
    ...
    function AddroomPage(router, fbauth, firestore) {
        this.router = router;
        this.fbauth = fbauth;
    ...
    AddroomPage.prototype.createRecord = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var postData, userLoggedIn;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        postData = this.firestore.collection("Rooms");
                        return [4 /*yield*/, this.fbauth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).toPromise()];
                    case 1:
                        userLoggedIn = _a.sent();
                        return [4 /*yield*/, postData.add({
                                Name: this.roomName,
    ...
    AddroomPage.ctorParameters = function () { return [
...
//# sourceMappingURL=addroom-addroom-module-es5.js.map