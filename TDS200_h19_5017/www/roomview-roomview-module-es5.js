...
var RoomviewPageModule = /** @class */ (function () {
    function RoomviewPageModule() {
    }
...
var RoomviewPage = /** @class */ (function () {
    function RoomviewPage(route, router, firestore, fbauth) {
        var _this = this;
        this.route = route;
        this.router = router;
        ...
        this.route.queryParams.subscribe(function () {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.room = _this.router.getCurrentNavigation().extras.state
                    .room;
            }
        });
    }
    // sletter rommet
    RoomviewPage.prototype.removeRecord = function (id) {
    ...
    RoomviewPage.prototype.updateRecord = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var userLoggedIn;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fbauth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])()).toPromise()];
                    case 1:
                        userLoggedIn = _a.sent();
                        this.router.navigate(["rooms"]);
                        return [2 /*return*/, this.firestore
                                .collection("Rooms")
                                .doc(id)
                                .update({
                                Status: "Unavailable",
    ...
    RoomviewPage.ctorParameters = function () { return [
...
//# sourceMappingURL=roomview-roomview-module-es5.js.map