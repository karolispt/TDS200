...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.userLogIn = function (_a) {
        var username = _a.username, password = _a.password;
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.fireauth.auth.signInWithEmailAndPassword(username, password)];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        });
    };
    AuthenticationService.prototype.userRegister = function (_a) {
        var username = _a.username, password = _a.password;
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.fireauth.auth.createUserWithEmailAndPassword(username, password)];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        });
